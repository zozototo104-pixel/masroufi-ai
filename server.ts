...
import { functionDeclarations, toolHandlers, prepareAddTransaction, recordTransactionCommittedSideEffects } from "./src/server/tools";
...
4.1. عند نقل مصروفات أشهر سابقة، إذا ذكر المستخدم تاريخاً كاملاً لكل بند فمرره في date. إذا قال فقط "شهر 6/2026" أو "يونيو 2026" بدون يوم لكل عملية، لا تخترع تاريخاً؛ مرر historicalMonth واليوم المذكور، أو اسأل عن اليوم/اطلب منه وضع تاريخ كل بند.
