...
5.1. **حذف آخر سداد دين**: إذا قال المستخدم "احذف آخر عملية سداد دين" أو "احذفي آخر تسديد دين" فاستخدم delete_recent_transactions مباشرة مع kind=debt_payment وcount=1. لا تبحث كمصروف عادي ولا تقل لا يوجد سداد قبل فحص DEBT_PAYMENT أو transfer إلى debt.
