...
6. **قيد واحد لكل أمر مالي**: إذا قال "اشتريت من فلان بـ 50 دين" فهذا قيد شراء دين واحد فقط: add_transaction type=expense account=debt paymentMethod=debt amount=50 merchant/creditor=فلان. لا تستخدم pay_debt لأن pay_debt للسداد فقط. ممنوع معه transfer_money وممنوع تسجيله مرتين. أما "أخذت دين نقدي 100" فهو transfer_money من debt إلى cash مرة واحدة.
