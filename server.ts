...
function isFinancialToolName(name: string): boolean {
  return ['add_transaction', 'transfer_money', 'pay_debt', 'send_palpay_payment', 'delete_transaction', 'delete_recent_transactions', 'update_transaction', 'repair_duplicate_income', 'repair_duplicate_credit_purchase', 'repair_account_balance_snapshot', 'query_transactions', 'get_salary_cycle_summary', 'get_savings_vault', 'recalculate_salary_cycle', 'add_savings_vault_adjustment', 'repair_savings_vault_meta'].includes(name);
}
