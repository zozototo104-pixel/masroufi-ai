...
Source commit: 18028420b46f440e35a308fcb8c682f30874b08c
Run: 34785509406
Install: success
Tests: failure
TypeScript: failure
...
src/server/tools.ts(1093,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(1391,200): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(1737,199): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2112,213): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2158,23): error TS2339: Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; } | { exists: boolean; data: () => any; partial: boolean; error: any; }'.
  Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; }'.
src/server/tools.ts(2180,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2188,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2214,39): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(2394,205): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2681,198): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3040,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 7 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3040,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 7 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3048,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3129,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3491,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(6196,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(8118,44): error TS2554: Expected 1 arguments, but got 2.
```
