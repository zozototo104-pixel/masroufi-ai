...
Source commit: d6b9b90520df0029d80933d3e1c285c1c6ab01d1
Run: 34807999695
Install: success
Tests: failure
TypeScript: failure
...
src/server/tools.ts(1823,199): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2210,213): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2256,23): error TS2339: Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; } | { exists: boolean; data: () => any; partial: boolean; error: any; }'.
  Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; }'.
src/server/tools.ts(2278,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2286,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2312,39): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(2502,205): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2816,198): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3182,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3182,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3190,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3271,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3633,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(6338,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(7497,33): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(8276,44): error TS2554: Expected 1 arguments, but got 2.
```
...
[2mdist/[22m[2massets/[22m[36mindex-hm2ww_Vi.js            [39m[1m[2m302.62 kB[22m[1m[22m[2m │ gzip:  70.70 kB[22m[2m │ map:   755.19 kB[22m
