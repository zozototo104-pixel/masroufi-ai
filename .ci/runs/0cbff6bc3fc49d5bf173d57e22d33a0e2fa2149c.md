...
Source commit: 0cbff6bc3fc49d5bf173d57e22d33a0e2fa2149c
Run: 34808535339
Install: success
Tests: failure
TypeScript: failure
...
src/server/tools.ts(2865,198): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3230,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3230,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3238,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3319,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3681,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(6386,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(7545,33): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(8338,44): error TS2554: Expected 1 arguments, but got 2.
```
