...
Source commit: 7c8ba9e2b5d9c56edd5d812fdf5cb5c465b62a4b
Run: 33960340229
Install: success
Tests: cancelled
TypeScript: skipped
...
ok 36 - CONC-13: reviewed receipt/import lines are prepared directly and persisted by one bounded batch
  ---
  duration_ms: 19.025209
--- tests log tail ---
  ...
# Subtest: MARKET-23: Bank of Israel FX payload parser preserves representative source date
ok 193 - MARKET-23: Bank of Israel FX payload parser preserves representative source date
  ---
  duration_ms: 0.394615
  type: 'test'
  ...
# Subtest: MARKET-24: converted FX market results expose source/date metadata and reject Infinity
ok 194 - MARKET-24: converted FX market results expose source/date metadata and reject Infinity
  ---
  duration_ms: 1.014178
  type: 'test'
  ...
# Subtest: MARKET-25: saved and live market results spread FX metadata when conversion succeeds
ok 195 - MARKET-25: saved and live market results spread FX metadata when conversion succeeds
  ---
  duration_ms: 5.263352
  type: 'test'
  ...
# Subtest: OFF-01: FakeDb.set returns durability=pending on Firestore failure
ok 196 - OFF-01: FakeDb.set returns durability=pending on Firestore failure
  ---
  duration_ms: 10.58687
  type: 'test'
  ...
# Subtest: OFF-02: offline queue persists in IndexedDB (survives browser reload)
ok 197 - OFF-02: offline queue persists in IndexedDB (survives browser reload)
  ---
  duration_ms: 3.824071
  type: 'test'
  ...
# Subtest: OFF-03: queue keyed by userId (survives Cloud Run restart, client-side)
ok 198 - OFF-03: queue keyed by userId (survives Cloud Run restart, client-side)
  ---
  duration_ms: 1.296414
  type: 'test'
  ...
# Subtest: OFF-04: syncPendingOps attempts to sync on fetchData
ok 199 - OFF-04: syncPendingOps attempts to sync on fetchData
  ---
  duration_ms: 2.369542
  type: 'test'
  ...
# Subtest: OFF-05: retry does not duplicate after the operation completed
ok 200 - OFF-05: retry does not duplicate after the operation completed
  ---
  duration_ms: 0.565774
  type: 'test'
  ...
# Subtest: OFF-06: server committed but response lost — retry returns cached result
ok 201 - OFF-06: server committed but response lost — retry returns cached result
  ---
  duration_ms: 1.140544
  type: 'test'
  ...
# Subtest: OFF-06B: offline income parser cannot manufacture server business confirmations
ok 202 - OFF-06B: offline income parser cannot manufacture server business confirmations
  ---
  duration_ms: 4.321086
  type: 'test'
  ...
