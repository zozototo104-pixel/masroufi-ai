...
Source commit: 3c2a9d0305c46e4cd56480b3988e44c53e188f22
Run: 34786082676
Install: success
Tests: failure
TypeScript: failure
...
src/server/tools.ts(2408,205): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2695,198): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3061,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3061,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3069,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3150,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3512,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(6217,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(8144,44): error TS2554: Expected 1 arguments, but got 2.
```
...
[2mdist/[22m[2massets/[22m[36mindex-D4udC4jn.js            [39m[1m[2m298.48 kB[22m[1m[22m[2m │ gzip:  70.06 kB[22m[2m │ map:   747.91 kB[22m
