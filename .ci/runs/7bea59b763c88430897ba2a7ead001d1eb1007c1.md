...
Source commit: 7bea59b763c88430897ba2a7ead001d1eb1007c1
Run: 34784625633
Install: success
Tests: failure
TypeScript: failure
...
src/server/tools.ts(2101,213): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2147,23): error TS2339: Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; } | { exists: boolean; data: () => any; partial: boolean; error: any; }'.
  Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; }'.
src/server/tools.ts(2169,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2177,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2203,39): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(2383,205): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2670,198): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3029,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 7 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3029,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 7 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3037,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3118,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3480,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(6185,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(8107,44): error TS2554: Expected 1 arguments, but got 2.
```
