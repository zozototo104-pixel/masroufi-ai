...
Source commit: 50dd8c4b7f5cd07a42e8f10001fa4d0121497e87
Run: 34834000939
Install: success
Tests: failure
TypeScript: failure
...
ok 144 - VAULT-10: voice month questions and explicit date ranges have separate contracts
  ---
  duration_ms: 7.187378
  type: 'test'
  ...
not ok 167 - READS-06: RESOURCE_EXHAUSTED must stop dashboard fan-out and be negative-cached
  ---
  duration_ms: 5.416395
  type: 'test'
  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:1:80659'
  failureType: 'testCodeFailure'
  error: 'cloud-health must cache quota exhaustion longer than normal health'
  code: 'ERR_ASSERTION'
  name: 'AssertionError'
  expected: true
  actual: false
  operator: '=='
  stack: |-
    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:1173:10)
    async Test.run (node:internal/test_runner/test:1054:7)
    async Test.processPendingSubtests (node:internal/test_runner/test:744:7)
  ...
# Subtest: IMPORT-01: image analysis retries temporary Gemini capacity but separates rate limits
ok 168 - IMPORT-01: image analysis retries temporary Gemini capacity but separates rate limits
  ---
  duration_ms: 6.248393
  type: 'test'
  ...
# Subtest: IMPORT-02: receipt record uses server balances and splits cash to PalPay before debt
ok 169 - IMPORT-02: receipt record uses server balances and splits cash to PalPay before debt
  ---
  duration_ms: 6.683264
  type: 'test'
  ...
# Subtest: DELETE-RECENT-01: voice can safely delete last N expenses or last debt payment without full ledger scan
ok 170 - DELETE-RECENT-01: voice can safely delete last N expenses or last debt payment without full ledger scan
  ---
  duration_ms: 10.458997
  type: 'test'
  ...
not ok 171 - DELETE-DATE-01: smart delete can find exact-date cash tracking rows outside recent createdAt window
  ---
  duration_ms: 9.347076
  type: 'test'
...
ok 187 - PIPE-06: offline financial commands go through /api/command only
  ---
  duration_ms: 6.860726
  type: 'test'
  ...
not ok 194 - VOICE-06: mobile barge-in resists speaker echo false positives
  ---
  duration_ms: 1.983688
  type: 'test'
  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/financial_pipeline.test.ts:1:7878'
  failureType: 'testCodeFailure'
...
not ok 209 - TREASURER-12: recurring commitment manager detects subscriptions and converts them safely
  ---
  duration_ms: 22.246685
  type: 'test'
  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/financial_pipeline.test.ts:1:28898'
  failureType: 'testCodeFailure'
...
ok 212 - TREASURER-15: adaptive budget engine proposes and applies smarter category limits safely
  ---
  duration_ms: 17.351029
  type: 'test'
  ...
not ok 215 - TREASURER-18: advisor dashboard numbers remain explainable and tied to real transaction dates
  ---
  duration_ms: 16.961514
  type: 'test'
  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/financial_pipeline.test.ts:1:53247'
  failureType: 'testCodeFailure'
  error: 'server is not defined'
  code: 'ERR_TEST_FAILURE'
  name: 'ReferenceError'
  stack: |-
    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/financial_pipeline.test.ts:627:13)
    async Test.run (node:internal/test_runner/test:1054:7)
    async Test.processPendingSubtests (node:internal/test_runner/test:744:7)
  ...
...
ok 218 - MARKET-03: isGazaSource detects Gaza/Palestine in title/URL
  ---
  duration_ms: 0.247255
  type: 'test'
  ...
# Subtest: MARKET-04: computePriceRange excludes outliers (>2x median)
ok 219 - MARKET-04: computePriceRange excludes outliers (>2x median)
  ---
```
...
943-  ---
944-  duration_ms: 11.408753
--
1080-ok 165 - EXPORT-01: CSV backup export must use the full export endpoint, not dashboard transactions
1081-  ---
1082-  duration_ms: 8.466576
1083-  type: 'test'
1084-  ...
1085-# Subtest: WIPE-01: destructive wipe fixes root cause by using Admin Firestore, no swallowed errors, and verification
1086-ok 166 - WIPE-01: destructive wipe fixes root cause by using Admin Firestore, no swallowed errors, and verification
1087-  ---
1088-  duration_ms: 8.877002
1089-  type: 'test'
1090-  ...
1091-# Subtest: READS-06: RESOURCE_EXHAUSTED must stop dashboard fan-out and be negative-cached
1092:not ok 167 - READS-06: RESOURCE_EXHAUSTED must stop dashboard fan-out and be negative-cached
1093-  ---
1094-  duration_ms: 5.416395
1095-  type: 'test'
1096-  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:1:80659'
1097-  failureType: 'testCodeFailure'
1098:  error: 'cloud-health must cache quota exhaustion longer than normal health'
1099:  code: 'ERR_ASSERTION'
1100:  name: 'AssertionError'
1101-  expected: true
1102-  actual: false
1103-  operator: '=='
1104-  stack: |-
1105-    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:1173:10)
1106-    async Test.run (node:internal/test_runner/test:1054:7)
1107-    async Test.processPendingSubtests (node:internal/test_runner/test:744:7)
1108-  ...
1109-# Subtest: IMPORT-01: image analysis retries temporary Gemini capacity but separates rate limits
1110-ok 168 - IMPORT-01: image analysis retries temporary Gemini capacity but separates rate limits
1111-  ---
1112-  duration_ms: 6.248393
--
1116-ok 169 - IMPORT-02: receipt record uses server balances and splits cash to PalPay before debt
1117-  ---
1118-  duration_ms: 6.683264
1119-  type: 'test'
1120-  ...
1121-# Subtest: DELETE-RECENT-01: voice can safely delete last N expenses or last debt payment without full ledger scan
1122-ok 170 - DELETE-RECENT-01: voice can safely delete last N expenses or last debt payment without full ledger scan
1123-  ---
1124-  duration_ms: 10.458997
1125-  type: 'test'
1126-  ...
1127-# Subtest: DELETE-DATE-01: smart delete can find exact-date cash tracking rows outside recent createdAt window
1128:not ok 171 - DELETE-DATE-01: smart delete can find exact-date cash tracking rows outside recent createdAt window
1129-  ---
1130-  duration_ms: 9.347076
1131-  type: 'test'
1132-  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:1:88907'
1133-  failureType: 'testCodeFailure'
1134:  error: 'smart delete must query the exact transaction date instead of only recent createdAt rows'
1135:  code: 'ERR_ASSERTION'
1136:  name: 'AssertionError'
1137-  expected: true
1138-  actual: false
1139-  operator: '=='
1140-  stack: |-
1141-    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:1228:10)
1142-    async Test.run (node:internal/test_runner/test:1054:7)
1143-    async Test.processPendingSubtests (node:internal/test_runner/test:744:7)
1144-  ...
1145-# Subtest: DEBT-REPORT-01: salary-cycle debt questions include repayments made after the cycle
1146-ok 172 - DEBT-REPORT-01: salary-cycle debt questions include repayments made after the cycle
1147-  ---
1148-  duration_ms: 6.849289
--
1164-ok 175 - VAULT-CURRENCY-02: currency deltas can be repaired from old and new vault adjustment shapes
1165-  ---
1166-  duration_ms: 0.400502
1167-  type: 'test'
1168-  ...
1169-# Subtest: VAULT-CURRENCY-03: tools and UI expose multi-currency vault fields without touching cash/PalPay/debt
1170-ok 176 - VAULT-CURRENCY-03: tools and UI expose multi-currency vault fields without touching cash/PalPay/debt
1171-  ---
1172-  duration_ms: 17.93091
1173-  type: 'test'
1174-  ...
1175-# Subtest: LIVE-01: voice path prevents duplicate expert playback and echo feedback loops
1176:not ok 177 - LIVE-01: voice path prevents duplicate expert playback and echo feedback loops
1177-  ---
1178-  duration_ms: 3.959063
1179-  type: 'test'
1180-  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:1:115691'
1181-  failureType: 'testCodeFailure'
1182:  error: 'barge-in threshold must resist speaker echo false positives'
1183:  code: 'ERR_ASSERTION'
1184:  name: 'AssertionError'
1185-  expected: true
1186-  actual: false
1187-  operator: '=='
1188-  stack: |-
1189-    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:1342:10)
1190-    async Test.run (node:internal/test_runner/test:1054:7)
1191-    async Test.processPendingSubtests (node:internal/test_runner/test:744:7)
1192-  ...
1193-# Subtest: LIVE-02: Gemini Live quota exhaustion is classified and surfaced to the user
1194:not ok 178 - LIVE-02: Gemini Live quota exhaustion is classified and surfaced to the user
1195-  ---
1196-  duration_ms: 4.982804
1197-  type: 'test'
1198-  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:1:119469'
1199-  failureType: 'testCodeFailure'
1200:  error: 'client must boost quiet Gemini Live playback loudly through one persistent compressed output chain without changing microphone input and must clean up audio nodes'
...
1205-  operator: '=='
1206-  stack: |-
1207-    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:1375:10)
...
1210-  ...
1211-# Subtest: REPORTS-06: Treasurer/monthly expense analysis must not refuse or misroute to today reads
1212-ok 179 - REPORTS-06: Treasurer/monthly expense analysis must not refuse or misroute to today reads
1213-  ---
1214-  duration_ms: 21.362229
1215-  type: 'test'
1216-  ...
1217-# Subtest: CLARIFICATION-03: payment/account clarification must complete the original financial operation without repeating questions
1218-ok 180 - CLARIFICATION-03: payment/account clarification must complete the original financial operation without repeating questions
1219-  ---
1220-  duration_ms: 13.931462
1221-  type: 'test'
1222-  ...
1223-# Subtest: CYCLES-UI-01: Savings Vault exposes salary-cycle navigation details and bounded delete
1224:not ok 181 - CYCLES-UI-01: Savings Vault exposes salary-cycle navigation details and bounded delete
1225-  ---
1226-  duration_ms: 14.907984
1227-  type: 'test'
1228-  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:1:131935'
1229-  failureType: 'testCodeFailure'
1230:  error: 'cycle query must remain bounded to the selected 27→26 date range'
...
1235-  operator: '=='
1236-  stack: |-
1237-    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:1441:10)
...
1240-  ...
1241-# Subtest: PIPE-01: financial writes must not pass through legacy /api/sync raw transaction doc.set
1242-ok 182 - PIPE-01: financial writes must not pass through legacy /api/sync raw transaction doc.set
1243-  ---
1244-  duration_ms: 44.103715
1245-  type: 'test'
1246-  ...
1247-# Subtest: PIPE-02: all mutating financial tools are protected by runIdempotent wrapper
1248-ok 183 - PIPE-02: all mutating financial tools are protected by runIdempotent wrapper
1249-  ---
1250-  duration_ms: 16.992129
1251-  type: 'test'
1252-  ...
1253-# Subtest: PIPE-03: idempotency uses hashed Firestore doc ids and fails closed
1254:not ok 184 - PIPE-03: idempotency uses hashed Firestore doc ids and fails closed
1255-  ---
1256-  duration_ms: 10.394227
1257-  type: 'test'
1258-  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/financial_pipeline.test.ts:1:1913'
1259-  failureType: 'testCodeFailure'
1260:  error: 'pending duplicates may wait only after the claim transaction has completed'
...
1265-  operator: '=='
1266-  stack: |-
1267-    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/financial_pipeline.test.ts:43:10)
...
1270-  ...
1271-# Subtest: PIPE-04: notifications cannot turn a committed financial write into a failure
1272-ok 185 - PIPE-04: notifications cannot turn a committed financial write into a failure
1273-  ---
1274-  duration_ms: 8.200383
--
1314-ok 192 - VOICE-04: Gemini Live forwards native audio without personal-voice interception
1315-  ---
1316-  duration_ms: 6.371363
1317-  type: 'test'
1318-  ...
1319-# Subtest: VOICE-05: interruption handling matches the original Gemini Live path
1320-ok 193 - VOICE-05: interruption handling matches the original Gemini Live path
1321-  ---
1322-  duration_ms: 4.400675
1323-  type: 'test'
1324-  ...
1325-# Subtest: VOICE-06: mobile barge-in resists speaker echo false positives
1326:not ok 194 - VOICE-06: mobile barge-in resists speaker echo false positives
1327-  ---
1328-  duration_ms: 1.983688
1329-  type: 'test'
1330-  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/financial_pipeline.test.ts:1:7878'
1331-  failureType: 'testCodeFailure'
1332:  error: 'barge-in must use a higher speech threshold to avoid echo-triggered cuts'
1333:  code: 'ERR_ASSERTION'
1334:  name: 'AssertionError'
1335-  expected: true
1336-  actual: false
1337-  operator: '=='
1338-  stack: |-
1339-    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/financial_pipeline.test.ts:120:10)
1340-    async Test.run (node:internal/test_runner/test:1054:7)
1341-    async Test.processPendingSubtests (node:internal/test_runner/test:744:7)
1342-  ...
1343-# Subtest: VOICE-07: websocket connect reads the latest selected voice
1344-ok 195 - VOICE-07: websocket connect reads the latest selected voice
1345-  ---
1346-  duration_ms: 2.013912
--
1416-ok 207 - TREASURER-10: goal impact engine protects financial goals before major spending
1417-  ---
1418-  duration_ms: 12.045078
1419-  type: 'test'
1420-  ...
1421-# Subtest: TREASURER-11: financial scenario simulator forecasts outcomes without recording transactions
1422-ok 208 - TREASURER-11: financial scenario simulator forecasts outcomes without recording transactions
1423-  ---
1424-  duration_ms: 12.75794
1425-  type: 'test'
1426-  ...
1427-# Subtest: TREASURER-12: recurring commitment manager detects subscriptions and converts them safely
1428:not ok 209 - TREASURER-12: recurring commitment manager detects subscriptions and converts them safely
1429-  ---
1430-  duration_ms: 22.246685
1431-  type: 'test'
1432-  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/financial_pipeline.test.ts:1:28898'
1433-  failureType: 'testCodeFailure'
1434:  error: 'commitment enrichment must handle Firestore timestamp due dates'
1435:  code: 'ERR_ASSERTION'
1436:  name: 'AssertionError'
1437-  expected: true
1438-  actual: false
1439-  operator: '=='
1440-  stack: |-
1441-    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/financial_pipeline.test.ts:345:10)
1442-    async Test.run (node:internal/test_runner/test:1054:7)
1443-    async Test.processPendingSubtests (node:internal/test_runner/test:744:7)
1444-  ...
1445-# Subtest: TREASURER-13: financial habit engine detects spending patterns and surfaces them to the advisor
1446-ok 210 - TREASURER-13: financial habit engine detects spending patterns and surfaces them to the advisor
1447-  ---
1448-  duration_ms: 14.807335
--
1464-ok 213 - TREASURER-16: month-end forecast engine predicts surplus pressure or deficit with corrections
1465-  ---
1466-  duration_ms: 12.875133
1467-  type: 'test'
1468-  ...
1469-# Subtest: TREASURER-17: daily financial pulse gives a practical today plan without pretending background automation
1470-ok 214 - TREASURER-17: daily financial pulse gives a practical today plan without pretending background automation
1471-  ---
1472-  duration_ms: 14.839782
1473-  type: 'test'
1474-  ...
1475-# Subtest: TREASURER-18: advisor dashboard numbers remain explainable and tied to real transaction dates
1476:not ok 215 - TREASURER-18: advisor dashboard numbers remain explainable and tied to real transaction dates
1477-  ---
1478-  duration_ms: 16.961514
1479-  type: 'test'
1480-  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/financial_pipeline.test.ts:1:53247'
1481-  failureType: 'testCodeFailure'
1482:  error: 'server is not defined'
1483-  code: 'ERR_TEST_FAILURE'
1484-  name: 'ReferenceError'
1485-  stack: |-
1486-    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/financial_pipeline.test.ts:627:13)
1487-    async Test.run (node:internal/test_runner/test:1054:7)
1488-    async Test.processPendingSubtests (node:internal/test_runner/test:744:7)
1489-  ...
1490-# Subtest: MARKET-01: extractPricesFromText parses "3200 ₪"
1491-ok 216 - MARKET-01: extractPricesFromText parses "3200 ₪"
1492-  ---
1493-  duration_ms: 2.145556
1494-  type: 'test'
```
...
src/App.tsx(269,100): error TS2769: No overload matches this call.
...
src/server/tools.ts(2589,205): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2601,10): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2937,198): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3302,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3302,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3310,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3391,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3753,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(6483,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(7656,33): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(8558,44): error TS2554: Expected 1 arguments, but got 2.
```
...
[2mdist/[22m[2massets/[22m[36mindex-0T75xSMo.js            [39m[1m[2m306.86 kB[22m[1m[22m[2m │ gzip:  71.89 kB[22m[2m │ map:   767.51 kB[22m
