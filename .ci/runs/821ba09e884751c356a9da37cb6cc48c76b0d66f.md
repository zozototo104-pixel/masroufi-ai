...
Source commit: 821ba09e884751c356a9da37cb6cc48c76b0d66f
Run: 34808723429
Install: success
Tests: failure
TypeScript: failure
...
src/server/tools.ts(1470,200): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(1842,199): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2234,213): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2280,23): error TS2339: Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; } | { exists: boolean; data: () => any; partial: boolean; error: any; }'.
  Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; }'.
src/server/tools.ts(2302,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2310,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2336,39): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(2533,205): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2872,198): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3237,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3237,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3245,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3326,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3688,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(6393,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(7552,33): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(8367,44): error TS2554: Expected 1 arguments, but got 2.
```
...
[2mdist/[22m[2massets/[22m[36mindex-BoCCOMcH.js            [39m[1m[2m303.78 kB[22m[1m[22m[2m │ gzip:  70.96 kB[22m[2m │ map:   757.16 kB[22m
