...
Source commit: 3e048c40def9d702d5e5a7f571d05095106a3d3c
Run: 33947915477
Install: success
Tests: failure
TypeScript: success
...
ok 17 - TOOL-05: smart delete asks confirmation even with single match (MF-6)
  ---
  duration_ms: 9.679307
  type: 'test'
  ...
# Subtest: TOOL-06: memory_search filters by query (MF-2)
ok 18 - TOOL-06: memory_search filters by query (MF-2)
  ---
  duration_ms: 10.094444
  type: 'test'
  ...
not ok 20 - TOOL-08: getFinancialDecisionContext propagates partial flag (DUR-04/28)
  ---
  duration_ms: 5.963615
  type: 'test'
  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/authorization.test.ts:1:5720'
  failureType: 'testCodeFailure'
  error: 'getFinancialDecisionContext must propagate partial flag'
  code: 'ERR_ASSERTION'
  name: 'AssertionError'
  expected: true
  actual: false
  operator: '=='
  stack: |-
    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/authorization.test.ts:139:10)
    async Test.run (node:internal/test_runner/test:1054:7)
    async Test.processPendingSubtests (node:internal/test_runner/test:744:7)
  ...
# Subtest: TOOL-09: commitments support paid/cancelled status (MF-1)
not ok 21 - TOOL-09: commitments support paid/cancelled status (MF-1)
  ---
  duration_ms: 5.960146
  type: 'test'
  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/authorization.test.ts:1:6049'
  failureType: 'testCodeFailure'
  error: 'forecast excludes paid/cancelled commitments'
  code: 'ERR_ASSERTION'
  name: 'AssertionError'
  expected: true
  actual: false
  operator: '=='
  stack: |-
    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/authorization.test.ts:149:10)
    async Test.run (node:internal/test_runner/test:1054:7)
    async Test.processPendingSubtests (node:internal/test_runner/test:744:7)
  ...
...
[32m✓ built in 4.27s[39m
  ...
  dist/server.cjs       635.8kb
  dist/server.cjs.map  1006.3kb
