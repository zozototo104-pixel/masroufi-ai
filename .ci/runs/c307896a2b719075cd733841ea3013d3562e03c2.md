...
Source commit: c307896a2b719075cd733841ea3013d3562e03c2
Run: 34786229147
Install: success
Tests: failure
TypeScript: failure
...
src/server/tools.ts(1114,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(1417,200): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(1763,199): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2138,213): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2184,23): error TS2339: Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; } | { exists: boolean; data: () => any; partial: boolean; error: any; }'.
  Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; }'.
src/server/tools.ts(2206,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2214,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2240,39): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(2422,205): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2709,198): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3075,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3075,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3083,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3164,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3526,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(6231,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(8158,44): error TS2554: Expected 1 arguments, but got 2.
```
