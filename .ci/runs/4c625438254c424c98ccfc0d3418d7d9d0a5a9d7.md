...
Source commit: 4c625438254c424c98ccfc0d3418d7d9d0a5a9d7
Run: 34788074928
Install: success
Tests: failure
TypeScript: failure
...
src/server/tools.ts(1469,200): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(1815,199): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2190,213): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2236,23): error TS2339: Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; } | { exists: boolean; data: () => any; partial: boolean; error: any; }'.
  Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; }'.
src/server/tools.ts(2258,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2266,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2292,39): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(2474,205): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2761,198): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3127,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3127,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3135,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3216,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3578,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(6283,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(8210,44): error TS2554: Expected 1 arguments, but got 2.
```
...
[2mdist/[22m[2massets/[22m[36mindex-ByLozxZd.js            [39m[1m[2m300.68 kB[22m[1m[22m[2m │ gzip:  70.44 kB[22m[2m │ map:   751.65 kB[22m
