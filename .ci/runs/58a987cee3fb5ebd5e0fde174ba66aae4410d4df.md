...
Source commit: 58a987cee3fb5ebd5e0fde174ba66aae4410d4df
Run: 34776747860
Install: success
Tests: failure
TypeScript: failure
...
ok 32 - CONC-09: stale pending idempotency keys never auto-reexecute financial mutations
  ---
  duration_ms: 0.740283
--- tests log tail ---
  ...
# Subtest: MARKET-23: Bank of Israel FX payload parser preserves representative source date
ok 230 - MARKET-23: Bank of Israel FX payload parser preserves representative source date
  ---
  duration_ms: 0.430731
  type: 'test'
  ...
# Subtest: MARKET-24: converted FX market results expose source/date metadata and reject Infinity
ok 231 - MARKET-24: converted FX market results expose source/date metadata and reject Infinity
  ---
  duration_ms: 1.030314
  type: 'test'
  ...
# Subtest: MARKET-25: saved and live market results spread FX metadata when conversion succeeds
ok 232 - MARKET-25: saved and live market results spread FX metadata when conversion succeeds
  ---
  duration_ms: 10.781971
  type: 'test'
  ...
# Subtest: OFF-01: FakeDb.set returns durability=pending on Firestore failure
ok 233 - OFF-01: FakeDb.set returns durability=pending on Firestore failure
  ---
  duration_ms: 13.483431
  type: 'test'
  ...
# Subtest: OFF-02: offline queue persists in IndexedDB (survives browser reload)
ok 234 - OFF-02: offline queue persists in IndexedDB (survives browser reload)
  ---
  duration_ms: 2.355025
  type: 'test'
  ...
# Subtest: OFF-03: queue keyed by userId (survives Cloud Run restart, client-side)
ok 235 - OFF-03: queue keyed by userId (survives Cloud Run restart, client-side)
  ---
  duration_ms: 3.062299
  type: 'test'
  ...
# Subtest: OFF-04: syncPendingOps attempts to sync on fetchData
ok 236 - OFF-04: syncPendingOps attempts to sync on fetchData
  ---
  duration_ms: 6.180752
  type: 'test'
  ...
# Subtest: OFF-05: retry does not duplicate after the operation completed
ok 237 - OFF-05: retry does not duplicate after the operation completed
  ---
  duration_ms: 0.546375
  type: 'test'
  ...
# Subtest: OFF-06: server committed but response lost — retry returns cached result
ok 238 - OFF-06: server committed but response lost — retry returns cached result
  ---
  duration_ms: 0.994448
  type: 'test'
  ...
# Subtest: OFF-06B: offline income parser cannot manufacture server business confirmations
ok 239 - OFF-06B: offline income parser cannot manufacture server business confirmations
  ---
  duration_ms: 6.048287
  type: 'test'
  ...
# Subtest: OFF-07: Login A → logout → Login B cannot see/sync A queue
ok 240 - OFF-07: Login A → logout → Login B cannot see/sync A queue
  ---
  duration_ms: 3.185729
  type: 'test'
  ...
# Subtest: OFF-08: pending ops include operationId, userId, commandType, args, createdAt, retryCount
ok 241 - OFF-08: pending ops include operationId, userId, commandType, args, createdAt, retryCount
  ---
  duration_ms: 1.448571
  type: 'test'
  ...
# Subtest: OFF-09: pending ops carry syncStatus states (PENDING, SYNCING, COMMITTED, FAILED)
ok 242 - OFF-09: pending ops carry syncStatus states (PENDING, SYNCING, COMMITTED, FAILED)
  ---
  duration_ms: 1.570228
  type: 'test'
  ...
# Subtest: ATOMIC-DEBT-01: payDebt no longer has txRef.set fallback after atomic failure
ok 243 - ATOMIC-DEBT-01: payDebt no longer has txRef.set fallback after atomic failure
  ---
  duration_ms: 15.651307
  type: 'test'
  ...
# Subtest: ATOMIC-DEBT-02: payDebt returns retryable=true on contention/quota
ok 244 - ATOMIC-DEBT-02: payDebt returns retryable=true on contention/quota
  ---
  duration_ms: 4.151413
  type: 'test'
  ...
# Subtest: TRANSFER-CONC-01: transferMoney uses atomicTransferMoney
ok 245 - TRANSFER-CONC-01: transferMoney uses atomicTransferMoney
  ---
  duration_ms: 4.595278
  type: 'test'
  ...
# Subtest: TRANSFER-CONC-02: atomicTransferMoney exists in atomicOps
ok 246 - TRANSFER-CONC-02: atomicTransferMoney exists in atomicOps
  ---
  duration_ms: 2.014733
  type: 'test'
  ...
# Subtest: TRANSFER-CONC-03: transferMoney has NO direct write fallback
ok 247 - TRANSFER-CONC-03: transferMoney has NO direct write fallback
  ---
  duration_ms: 3.257202
  type: 'test'
  ...
# Subtest: OFFLINE-COMMAND-01: offlineQueue stores commandType + args (not final document)
ok 248 - OFFLINE-COMMAND-01: offlineQueue stores commandType + args (not final document)
  ---
  duration_ms: 1.794685
  type: 'test'
  ...
# Subtest: OFFLINE-COMMAND-02: offlineQueue sends through /api/command (NOT /api/sync)
ok 249 - OFFLINE-COMMAND-02: offlineQueue sends through /api/command (NOT /api/sync)
  ---
  duration_ms: 1.201092
  type: 'test'
  ...
# Subtest: OFFLINE-COMMAND-03: /api/command endpoint exists in server.ts
ok 250 - OFFLINE-COMMAND-03: /api/command endpoint exists in server.ts
  ---
  duration_ms: 5.534823
  type: 'test'
  ...
# Subtest: OFFLINE-COMMAND-04: dispatchFinancialCommand routes to tool handlers
ok 251 - OFFLINE-COMMAND-04: dispatchFinancialCommand routes to tool handlers
  ---
  duration_ms: 1.196093
  type: 'test'
  ...
# Subtest: OFFLINE-COMMAND-05: /api/sync is NOT a financial backdoor (syncOfflineData does doc.set for non-financial only)
ok 252 - OFFLINE-COMMAND-05: /api/sync is NOT a financial backdoor (syncOfflineData does doc.set for non-financial only)
  ---
  duration_ms: 2.009549
  type: 'test'
  ...
# Subtest: UNIFIED-PENDING-01: V6.2 uses new queue key (masrofi_pending_ops_v6_2)
ok 253 - UNIFIED-PENDING-01: V6.2 uses new queue key (masrofi_pending_ops_v6_2)
  ---
  duration_ms: 1.481006
  type: 'test'
  ...
# Subtest: UNIFIED-PENDING-02: migrateLegacyPendingOps function exists
ok 254 - UNIFIED-PENDING-02: migrateLegacyPendingOps function exists
  ---
  duration_ms: 0.907787
  type: 'test'
  ...
# Subtest: UNIFIED-PENDING-03: App.tsx calls migrateLegacyPendingOps on fetchData
ok 255 - UNIFIED-PENDING-03: App.tsx calls migrateLegacyPendingOps on fetchData
  ---
  duration_ms: 2.19603
  type: 'test'
  ...
# Subtest: UNIFIED-PENDING-04: logout clears ALL pending keys (v6_2 + legacy)
ok 256 - UNIFIED-PENDING-04: logout clears ALL pending keys (v6_2 + legacy)
  ---
  duration_ms: 2.348283
  type: 'test'
  ...
# Subtest: PARTIAL-STATE-01: addTransaction rejects on partial snapshot
ok 257 - PARTIAL-STATE-01: addTransaction rejects on partial snapshot
  ---
  duration_ms: 3.744547
  type: 'test'
  ...
# Subtest: PARTIAL-STATE-02: transferMoney rejects on partial balance
ok 258 - PARTIAL-STATE-02: transferMoney rejects on partial balance
  ---
  duration_ms: 2.846818
  type: 'test'
  ...
# Subtest: PARTIAL-STATE-03: payDebt rejects on partial snapshot
ok 259 - PARTIAL-STATE-03: payDebt rejects on partial snapshot
  ---
  duration_ms: 7.207672
  type: 'test'
  ...
# Subtest: FIRESTORE-READS-01: atomic ops use runTransaction (O(N) acknowledged, V7 will add financialState)
ok 260 - FIRESTORE-READS-01: atomic ops use runTransaction (O(N) acknowledged, V7 will add financialState)
  ---
  duration_ms: 5.37184
  type: 'test'
  ...
# Subtest: STATIC-SAFETY-01: no "catch + txRef.set" pattern in payDebt
ok 261 - STATIC-SAFETY-01: no "catch + txRef.set" pattern in payDebt
  ---
  duration_ms: 3.413841
  type: 'test'
  ...
# Subtest: STATIC-SAFETY-02: no "catch + txRef.set" pattern in transferMoney
ok 262 - STATIC-SAFETY-02: no "catch + txRef.set" pattern in transferMoney
  ---
  duration_ms: 4.142026
  type: 'test'
  ...
# Subtest: SYNC-AUTH-01: dispatchFinancialCommand overwrites client userId
ok 263 - SYNC-AUTH-01: dispatchFinancialCommand overwrites client userId
  ---
  duration_ms: 1.93198
  type: 'test'
  ...
# Subtest: IDEM-01: dispatchFinancialCommand passes operationId through args
ok 264 - IDEM-01: dispatchFinancialCommand passes operationId through args
  ---
  duration_ms: 0.781422
  type: 'test'
  ...
1..264
# tests 264
...
src/server/tools.ts(5871,30): error TS2304: Cannot find name 'normalizeRecurringCommitmentFrequency'.
src/server/tools.ts(6158,44): error TS2554: Expected 1 arguments, but got 2.
```
...
[2mdist/[22m[2massets/[22m[35mindex-ChM3Mk8q.css           [39m[1m[2m 69.16 kB[22m[1m[22m[2m │ gzip:  11.55 kB[22m
[2mdist/[22m[2massets/[22m[36mvendor-charts-Dvqlu1dm.js    [39m[1m[2m 53.47 kB[22m[1m[22m[2m │ gzip:  18.63 kB[22m[2m │ map:   225.59 kB[22m
[2mdist/[22m[2massets/[22m[36mindex-BPBpib8U.js            [39m[1m[2m259.88 kB[22m[1m[22m[2m │ gzip:  63.78 kB[22m[2m │ map:   656.40 kB[22m
[2mdist/[22m[2massets/[22m[36mvendor-firebase-DvGIsY1I.js  [39m[1m[2m337.41 kB[22m[1m[22m[2m │ gzip:  78.75 kB[22m[2m │ map: 2,305.04 kB[22m
[2mdist/[22m[2massets/[22m[36mvendor-Bup65d-N.js           [39m[1m[2m489.10 kB[22m[1m[22m[2m │ gzip: 151.83 kB[22m[2m │ map: 2,113.05 kB[22m
[32m✓ built in 5.23s[39m

  dist/server.cjs      1.1mb ⚠️
