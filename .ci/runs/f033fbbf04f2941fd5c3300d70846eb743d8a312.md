...
Source commit: f033fbbf04f2941fd5c3300d70846eb743d8a312
Run: 33987587906
Install: success
Tests: failure
...
## failing tests
```text
not ok 98 - FIN-17: non-finite amounts cannot poison canonical balances or breakdowns
  ---
  duration_ms: 11.839515
  type: 'test'
  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:1:7889'
  ...
  stack: |-
    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:216:10)
    Test.runInAsyncScope (node:async_hooks:214:14)
not ok 153 - MOBILE-01: large app modals are iPhone-safe and scrollable
  ---
  duration_ms: 3.482309
  type: 'test'
...
## not-ok context
```text
578-ok 96 - FIN-15: duplicate after restart executes once — persistent idempotency
579-  ---
580-  duration_ms: 0.097052
581-  type: 'test'
582-  ...
583-# Subtest: FIN-16: PalPay malformed amounts collapse to invalid zero through the shared parser
584-ok 97 - FIN-16: PalPay malformed amounts collapse to invalid zero through the shared parser
585-  ---
586-  duration_ms: 0.132485
587-  type: 'test'
588-  ...
589-# Subtest: FIN-17: non-finite amounts cannot poison canonical balances or breakdowns
590:not ok 98 - FIN-17: non-finite amounts cannot poison canonical balances or breakdowns
591-  ---
592-  duration_ms: 11.839515
593-  type: 'test'
594-  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:1:7889'
595-  failureType: 'testCodeFailure'
596:  error: |-
597-    Expected values to be strictly deep-equal:
598-    + actual - expected
599-    
600-      {
601-        cash: 25,
...
606-      }
607-    
608:  code: 'ERR_ASSERTION'
609:  name: 'AssertionError'
610-  expected:
611-    cash: 25
612-    palPay: 0
613-    debt: 0
...
619-    vault: 0
620-    total: 25
621-  operator: 'deepStrictEqual'
--
944-ok 151 - WIPE-01: destructive wipe fixes root cause by using Admin Firestore, no swallowed errors, and verification
945-  ---
946-  duration_ms: 5.556369
947-  type: 'test'
948-  ...
949-# Subtest: READS-06: RESOURCE_EXHAUSTED must stop dashboard fan-out and be negative-cached
950-ok 152 - READS-06: RESOURCE_EXHAUSTED must stop dashboard fan-out and be negative-cached
951-  ---
952-  duration_ms: 4.988022
953-  type: 'test'
954-  ...
955-# Subtest: MOBILE-01: large app modals are iPhone-safe and scrollable
956:not ok 153 - MOBILE-01: large app modals are iPhone-safe and scrollable
957-  ---
958-  duration_ms: 3.482309
959-  type: 'test'
960-  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:1:57129'
961-  failureType: 'testCodeFailure'
962:  error: 'Reports UI modals must be covered by the mobile-safe conversion'
963:  code: 'ERR_ASSERTION'
964:  name: 'AssertionError'
965-  expected: true
966-  actual: false
967-  operator: '=='
968-  stack: |-
969-    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:978:10)
970-    async Test.run (node:internal/test_runner/test:1054:7)
971-    async Test.processPendingSubtests (node:internal/test_runner/test:744:7)
972-  ...
973-# Subtest: VAULT-CURRENCY-01: manual vault carryover preserves original ILS/USD/EUR amounts separately
974-ok 154 - VAULT-CURRENCY-01: manual vault carryover preserves original ILS/USD/EUR amounts separately
975-  ---
976-  duration_ms: 0.873505
```
