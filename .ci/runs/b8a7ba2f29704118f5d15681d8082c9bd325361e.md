...
Source commit: b8a7ba2f29704118f5d15681d8082c9bd325361e
Run: 34018630789
Install: success
Tests: success
TypeScript: failure
...
src/server/tools.ts(2732,51): error TS2339: Property 'reason' does not exist on type '{ ok: true; deleted: any[]; balances: BalanceSnapshot; balanceReadSource: string; } | { ok: false; reason: string; balances?: any; found?: number; requested?: number; }'.
  Property 'reason' does not exist on type '{ ok: true; deleted: any[]; balances: BalanceSnapshot; balanceReadSource: string; }'.
src/server/tools.ts(2732,97): error TS2339: Property 'found' does not exist on type '{ ok: true; deleted: any[]; balances: BalanceSnapshot; balanceReadSource: string; } | { ok: false; reason: string; balances?: any; found?: number; requested?: number; }'.
