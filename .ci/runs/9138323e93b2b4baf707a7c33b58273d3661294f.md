...
Source commit: 9138323e93b2b4baf707a7c33b58273d3661294f
Run: 34784427718
Install: success
Tests: failure
TypeScript: failure
...
src/server/tools.ts(2048,213): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2094,23): error TS2339: Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; } | { exists: boolean; data: () => any; partial: boolean; error: any; }'.
  Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; }'.
src/server/tools.ts(2116,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2124,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2150,39): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(2330,205): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2617,198): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2976,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 7 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(2976,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 7 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(2984,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3065,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3427,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(6132,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(8054,44): error TS2554: Expected 1 arguments, but got 2.
```
