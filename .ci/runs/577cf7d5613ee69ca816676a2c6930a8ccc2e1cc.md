...
Source commit: 577cf7d5613ee69ca816676a2c6930a8ccc2e1cc
Run: 34789090476
Install: success
Tests: failure
TypeScript: failure
...
src/server/tools.ts(2774,198): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3140,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3140,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3148,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3229,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3591,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(6296,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(8244,44): error TS2554: Expected 1 arguments, but got 2.
```
