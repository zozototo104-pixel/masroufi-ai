...
Source commit: a317d051773a711d3f7cb370b59c146302c1ebd0
Run: 34787088009
Install: success
Tests: failure
TypeScript: failure
...
src/server/tools.ts(1119,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(1422,200): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(1768,199): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2143,213): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2189,23): error TS2339: Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; } | { exists: boolean; data: () => any; partial: boolean; error: any; }'.
  Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; }'.
src/server/tools.ts(2211,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2219,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2245,39): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(2427,205): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2714,198): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3080,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3080,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3088,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3169,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3531,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(6236,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(8163,44): error TS2554: Expected 1 arguments, but got 2.
```
