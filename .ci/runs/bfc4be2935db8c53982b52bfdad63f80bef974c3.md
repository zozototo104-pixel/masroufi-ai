...
Source commit: bfc4be2935db8c53982b52bfdad63f80bef974c3
Run: 34040795852
Install: success
Tests: cancelled
TypeScript: skipped
...
ok 36 - CONC-13: reviewed receipt/import lines are prepared directly and persisted by one bounded batch
  ---
  duration_ms: 4.979573
--- tests log tail ---
  ...
# Subtest: MARKET-23: Bank of Israel FX payload parser preserves representative source date
ok 213 - MARKET-23: Bank of Israel FX payload parser preserves representative source date
  ---
  duration_ms: 0.428698
  type: 'test'
  ...
# Subtest: MARKET-24: converted FX market results expose source/date metadata and reject Infinity
ok 214 - MARKET-24: converted FX market results expose source/date metadata and reject Infinity
  ---
  duration_ms: 1.152384
  type: 'test'
  ...
# Subtest: MARKET-25: saved and live market results spread FX metadata when conversion succeeds
ok 215 - MARKET-25: saved and live market results spread FX metadata when conversion succeeds
  ---
  duration_ms: 6.339713
  type: 'test'
  ...
# Subtest: OFF-01: FakeDb.set returns durability=pending on Firestore failure
ok 216 - OFF-01: FakeDb.set returns durability=pending on Firestore failure
  ---
  duration_ms: 12.879728
  type: 'test'
  ...
# Subtest: OFF-02: offline queue persists in IndexedDB (survives browser reload)
ok 217 - OFF-02: offline queue persists in IndexedDB (survives browser reload)
  ---
  duration_ms: 3.150844
  type: 'test'
  ...
# Subtest: OFF-03: queue keyed by userId (survives Cloud Run restart, client-side)
ok 218 - OFF-03: queue keyed by userId (survives Cloud Run restart, client-side)
  ---
  duration_ms: 3.152631
  type: 'test'
  ...
# Subtest: OFF-04: syncPendingOps attempts to sync on fetchData
ok 219 - OFF-04: syncPendingOps attempts to sync on fetchData
  ---
  duration_ms: 3.727073
  type: 'test'
  ...
# Subtest: OFF-05: retry does not duplicate after the operation completed
ok 220 - OFF-05: retry does not duplicate after the operation completed
  ---
  duration_ms: 0.592793
  type: 'test'
  ...
# Subtest: OFF-06: server committed but response lost — retry returns cached result
ok 221 - OFF-06: server committed but response lost — retry returns cached result
  ---
  duration_ms: 1.077624
  type: 'test'
  ...
# Subtest: OFF-06B: offline income parser cannot manufacture server business confirmations
ok 222 - OFF-06B: offline income parser cannot manufacture server business confirmations
  ---
  duration_ms: 5.687269
  type: 'test'
  ...
