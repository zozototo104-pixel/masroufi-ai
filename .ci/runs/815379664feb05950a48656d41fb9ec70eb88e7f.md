...
Source commit: 815379664feb05950a48656d41fb9ec70eb88e7f
Run: 34832829188
Install: success
Tests: failure
TypeScript: failure
...
src/server/tools.ts(2578,205): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2917,198): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3282,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3282,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3290,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3371,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3733,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(6456,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(7615,33): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(8517,44): error TS2554: Expected 1 arguments, but got 2.
```
