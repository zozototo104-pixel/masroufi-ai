...
Source commit: 55511b2addfd7a38e8d4bb251aad6ecf1151c6ea
Run: 34785865219
Install: success
Tests: failure
TypeScript: failure
...
src/server/tools.ts(1100,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(1403,200): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(1749,199): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2124,213): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2170,23): error TS2339: Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; } | { exists: boolean; data: () => any; partial: boolean; error: any; }'.
  Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; }'.
src/server/tools.ts(2192,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2200,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2226,39): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(2406,205): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2693,198): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3059,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3059,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3067,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3148,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3510,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(6215,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(8142,44): error TS2554: Expected 1 arguments, but got 2.
```
...
[2mdist/[22m[2massets/[22m[36mindex-CL_sWBnT.js            [39m[1m[2m297.40 kB[22m[1m[22m[2m │ gzip:  69.77 kB[22m[2m │ map:   746.10 kB[22m
