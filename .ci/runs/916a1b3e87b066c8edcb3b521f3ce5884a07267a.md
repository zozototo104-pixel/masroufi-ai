...
Source commit: 916a1b3e87b066c8edcb3b521f3ce5884a07267a
Run: 34026168959
Install: success
Tests: failure
TypeScript: failure
...
## failing tests
```text
not ok 141 - VAULT-14: Savings Vault is separated from cash, PalPay, debt, and Personal Voice
  ---
  duration_ms: 18.252933
  type: 'test'
  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:1:40772'
  ...
  operator: '=='
  stack: |-
    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:831:10)
    async Test.run (node:internal/test_runner/test:1054:7)
    async Test.processPendingSubtests (node:internal/test_runner/test:744:7)
  ...
# Subtest: NLU-01: Arabic month and debt phrases route to salary-cycle tools without saying دورة
ok 142 - NLU-01: Arabic month and debt phrases route to salary-cycle tools without saying دورة
  ---
  duration_ms: 12.179161
  type: 'test'
  ...
# Subtest: VAULT-14A: close-month remainder goes to salary-cycle vault lock, not debt payment
ok 143 - VAULT-14A: close-month remainder goes to salary-cycle vault lock, not debt payment
  ---
  duration_ms: 7.001909
  type: 'test'
  ...
# Subtest: VAULT-14D: UI provides direct repair for misrouted creditor-surplus vault close
ok 144 - VAULT-14D: UI provides direct repair for misrouted creditor-surplus vault close
  ---
  duration_ms: 6.132264
  type: 'test'
  ...
```
...
## not-ok context
```text
836-ok 139 - VAULT-12: Firestore read-cost regressions are guarded for notifications, reports, and refresh
837-  ---
838-  duration_ms: 10.43503
839-  type: 'test'
840-  ...
841-# Subtest: VAULT-13: Savings Vault refuses unsafe partial or saturated authoritative commits
842-ok 140 - VAULT-13: Savings Vault refuses unsafe partial or saturated authoritative commits
843-  ---
844-  duration_ms: 3.744657
845-  type: 'test'
846-  ...
847-# Subtest: VAULT-14: Savings Vault is separated from cash, PalPay, debt, and Personal Voice
848:not ok 141 - VAULT-14: Savings Vault is separated from cash, PalPay, debt, and Personal Voice
849-  ---
850-  duration_ms: 18.252933
851-  type: 'test'
852-  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:1:40772'
853-  failureType: 'testCodeFailure'
854:  error: 'spendable card must be scoped to the active salary cycle, not global vault subtraction'
...
859-  operator: '=='
860-  stack: |-
861-    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:831:10)
...
864-  ...
865-# Subtest: NLU-01: Arabic month and debt phrases route to salary-cycle tools without saying دورة
866-ok 142 - NLU-01: Arabic month and debt phrases route to salary-cycle tools without saying دورة
867-  ---
868-  duration_ms: 12.179161
```
...
ok 36 - CONC-13: reviewed receipt/import lines are prepared directly and persisted by one bounded batch
  ---
  duration_ms: 5.033431
--- tests log tail ---
  ...
# Subtest: MARKET-23: Bank of Israel FX payload parser preserves representative source date
ok 210 - MARKET-23: Bank of Israel FX payload parser preserves representative source date
  ---
  duration_ms: 0.42518
  type: 'test'
  ...
# Subtest: MARKET-24: converted FX market results expose source/date metadata and reject Infinity
ok 211 - MARKET-24: converted FX market results expose source/date metadata and reject Infinity
  ---
  duration_ms: 1.058426
  type: 'test'
  ...
# Subtest: MARKET-25: saved and live market results spread FX metadata when conversion succeeds
ok 212 - MARKET-25: saved and live market results spread FX metadata when conversion succeeds
  ---
  duration_ms: 6.757276
  type: 'test'
  ...
# Subtest: OFF-01: FakeDb.set returns durability=pending on Firestore failure
ok 213 - OFF-01: FakeDb.set returns durability=pending on Firestore failure
  ---
  duration_ms: 9.806714
  type: 'test'
  ...
# Subtest: OFF-02: offline queue persists in IndexedDB (survives browser reload)
ok 214 - OFF-02: offline queue persists in IndexedDB (survives browser reload)
  ---
  duration_ms: 5.36949
  type: 'test'
  ...
# Subtest: OFF-03: queue keyed by userId (survives Cloud Run restart, client-side)
ok 215 - OFF-03: queue keyed by userId (survives Cloud Run restart, client-side)
  ---
  duration_ms: 3.642962
  type: 'test'
  ...
# Subtest: OFF-04: syncPendingOps attempts to sync on fetchData
ok 216 - OFF-04: syncPendingOps attempts to sync on fetchData
  ---
  duration_ms: 3.186201
  type: 'test'
  ...
# Subtest: OFF-05: retry does not duplicate after the operation completed
ok 217 - OFF-05: retry does not duplicate after the operation completed
  ---
  duration_ms: 0.382663
  type: 'test'
  ...
# Subtest: OFF-06: server committed but response lost — retry returns cached result
ok 218 - OFF-06: server committed but response lost — retry returns cached result
  ---
  duration_ms: 0.697714
  type: 'test'
  ...
# Subtest: OFF-06B: offline income parser cannot manufacture server business confirmations
ok 219 - OFF-06B: offline income parser cannot manufacture server business confirmations
  ---
  duration_ms: 3.012561
  type: 'test'
  ...
# Subtest: OFF-07: Login A → logout → Login B cannot see/sync A queue
ok 220 - OFF-07: Login A → logout → Login B cannot see/sync A queue
  ---
  duration_ms: 1.874782
  type: 'test'
  ...
# Subtest: OFF-08: pending ops include operationId, userId, commandType, args, createdAt, retryCount
ok 221 - OFF-08: pending ops include operationId, userId, commandType, args, createdAt, retryCount
  ---
  duration_ms: 1.365623
  type: 'test'
  ...
# Subtest: OFF-09: pending ops carry syncStatus states (PENDING, SYNCING, COMMITTED, FAILED)
ok 222 - OFF-09: pending ops carry syncStatus states (PENDING, SYNCING, COMMITTED, FAILED)
  ---
  duration_ms: 1.214296
  type: 'test'
  ...
# Subtest: ATOMIC-DEBT-01: payDebt no longer has txRef.set fallback after atomic failure
ok 223 - ATOMIC-DEBT-01: payDebt no longer has txRef.set fallback after atomic failure
  ---
  duration_ms: 10.198384
  type: 'test'
  ...
# Subtest: ATOMIC-DEBT-02: payDebt returns retryable=true on contention/quota
ok 224 - ATOMIC-DEBT-02: payDebt returns retryable=true on contention/quota
  ---
  duration_ms: 2.324553
  type: 'test'
  ...
# Subtest: TRANSFER-CONC-01: transferMoney uses atomicTransferMoney
ok 225 - TRANSFER-CONC-01: transferMoney uses atomicTransferMoney
  ---
  duration_ms: 2.340146
  type: 'test'
  ...
# Subtest: TRANSFER-CONC-02: atomicTransferMoney exists in atomicOps
ok 226 - TRANSFER-CONC-02: atomicTransferMoney exists in atomicOps
  ---
  duration_ms: 0.903473
  type: 'test'
  ...
# Subtest: TRANSFER-CONC-03: transferMoney has NO direct write fallback
ok 227 - TRANSFER-CONC-03: transferMoney has NO direct write fallback
  ---
  duration_ms: 3.391746
  type: 'test'
  ...
# Subtest: OFFLINE-COMMAND-01: offlineQueue stores commandType + args (not final document)
ok 228 - OFFLINE-COMMAND-01: offlineQueue stores commandType + args (not final document)
  ---
  duration_ms: 0.958428
  type: 'test'
  ...
# Subtest: OFFLINE-COMMAND-02: offlineQueue sends through /api/command (NOT /api/sync)
ok 229 - OFFLINE-COMMAND-02: offlineQueue sends through /api/command (NOT /api/sync)
  ---
  duration_ms: 0.907216
  type: 'test'
  ...
# Subtest: OFFLINE-COMMAND-03: /api/command endpoint exists in server.ts
ok 230 - OFFLINE-COMMAND-03: /api/command endpoint exists in server.ts
  ---
  duration_ms: 1.741872
  type: 'test'
  ...
# Subtest: OFFLINE-COMMAND-04: dispatchFinancialCommand routes to tool handlers
ok 231 - OFFLINE-COMMAND-04: dispatchFinancialCommand routes to tool handlers
  ---
  duration_ms: 1.090243
  type: 'test'
  ...
# Subtest: OFFLINE-COMMAND-05: /api/sync is NOT a financial backdoor (syncOfflineData does doc.set for non-financial only)
ok 232 - OFFLINE-COMMAND-05: /api/sync is NOT a financial backdoor (syncOfflineData does doc.set for non-financial only)
  ---
  duration_ms: 1.315541
  type: 'test'
  ...
# Subtest: UNIFIED-PENDING-01: V6.2 uses new queue key (masrofi_pending_ops_v6_2)
ok 233 - UNIFIED-PENDING-01: V6.2 uses new queue key (masrofi_pending_ops_v6_2)
  ---
  duration_ms: 0.908523
  type: 'test'
  ...
# Subtest: UNIFIED-PENDING-02: migrateLegacyPendingOps function exists
ok 234 - UNIFIED-PENDING-02: migrateLegacyPendingOps function exists
  ---
  duration_ms: 0.773184
  type: 'test'
  ...
# Subtest: UNIFIED-PENDING-03: App.tsx calls migrateLegacyPendingOps on fetchData
ok 235 - UNIFIED-PENDING-03: App.tsx calls migrateLegacyPendingOps on fetchData
  ---
  duration_ms: 1.942736
  type: 'test'
  ...
# Subtest: UNIFIED-PENDING-04: logout clears ALL pending keys (v6_2 + legacy)
ok 236 - UNIFIED-PENDING-04: logout clears ALL pending keys (v6_2 + legacy)
  ---
  duration_ms: 2.532856
  type: 'test'
  ...
# Subtest: PARTIAL-STATE-01: addTransaction rejects on partial snapshot
ok 237 - PARTIAL-STATE-01: addTransaction rejects on partial snapshot
  ---
  duration_ms: 3.762878
  type: 'test'
  ...
# Subtest: PARTIAL-STATE-02: transferMoney rejects on partial balance
ok 238 - PARTIAL-STATE-02: transferMoney rejects on partial balance
  ---
  duration_ms: 3.040131
  type: 'test'
  ...
# Subtest: PARTIAL-STATE-03: payDebt rejects on partial snapshot
ok 239 - PARTIAL-STATE-03: payDebt rejects on partial snapshot
  ---
  duration_ms: 2.167133
  type: 'test'
  ...
# Subtest: FIRESTORE-READS-01: atomic ops use runTransaction (O(N) acknowledged, V7 will add financialState)
ok 240 - FIRESTORE-READS-01: atomic ops use runTransaction (O(N) acknowledged, V7 will add financialState)
  ---
  duration_ms: 0.883775
  type: 'test'
  ...
# Subtest: STATIC-SAFETY-01: no "catch + txRef.set" pattern in payDebt
ok 241 - STATIC-SAFETY-01: no "catch + txRef.set" pattern in payDebt
  ---
  duration_ms: 2.199414
  type: 'test'
  ...
# Subtest: STATIC-SAFETY-02: no "catch + txRef.set" pattern in transferMoney
ok 242 - STATIC-SAFETY-02: no "catch + txRef.set" pattern in transferMoney
  ---
  duration_ms: 3.377866
  type: 'test'
  ...
# Subtest: SYNC-AUTH-01: dispatchFinancialCommand overwrites client userId
ok 243 - SYNC-AUTH-01: dispatchFinancialCommand overwrites client userId
  ---
  duration_ms: 0.822701
  type: 'test'
  ...
# Subtest: IDEM-01: dispatchFinancialCommand passes operationId through args
ok 244 - IDEM-01: dispatchFinancialCommand passes operationId through args
  ---
  duration_ms: 0.741773
  type: 'test'
  ...
1..244
# tests 244
