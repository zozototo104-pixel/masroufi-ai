...
Source commit: 8096fc21759323e5776763e5a68aa12bf19d6043
Run: 34821786706
Install: success
Tests: failure
TypeScript: failure
...
not ok 215 - TREASURER-18: advisor dashboard numbers remain explainable and tied to real transaction dates
  ...
  operator: '=='
  stack: |-
    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/financial_pipeline.test.ts:571:10)
    async Test.run (node:internal/test_runner/test:1054:7)
    async Test.processPendingSubtests (node:internal/test_runner/test:744:7)
  ...
...
1463-  operator: '=='
1464-  stack: |-
1465-    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/financial_pipeline.test.ts:571:10)
...
src/server/tools.ts(1484,200): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(1856,199): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2248,213): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2294,23): error TS2339: Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; } | { exists: boolean; data: () => any; partial: boolean; error: any; }'.
  Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; }'.
src/server/tools.ts(2316,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2324,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2350,39): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(2547,205): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2886,198): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3251,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3251,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3259,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3340,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3702,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(6407,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(7566,33): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(8381,44): error TS2554: Expected 1 arguments, but got 2.
```
...
[2mdist/[22m[2massets/[22m[36mindex-CLbVJAZC.js            [39m[1m[2m303.78 kB[22m[1m[22m[2m │ gzip:  70.96 kB[22m[2m │ map:   757.17 kB[22m
