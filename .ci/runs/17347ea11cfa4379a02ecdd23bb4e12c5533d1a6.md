...
Source commit: 17347ea11cfa4379a02ecdd23bb4e12c5533d1a6
Run: 34774306045
Install: success
Tests: failure
TypeScript: failure
...
src/server/tools.ts(1231,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 7 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(1231,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 7 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(1239,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(1320,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(1682,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(4346,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(5941,44): error TS2554: Expected 1 arguments, but got 2.
```
