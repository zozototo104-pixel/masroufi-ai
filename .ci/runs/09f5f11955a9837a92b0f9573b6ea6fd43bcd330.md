...
Source commit: 09f5f11955a9837a92b0f9573b6ea6fd43bcd330
Run: 34780085210
Install: success
Tests: failure
TypeScript: failure
...
src/server/tools.ts(2275,205): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2634,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 7 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(2634,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 7 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(2642,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2723,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3085,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(5790,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(7712,44): error TS2554: Expected 1 arguments, but got 2.
```
