...
Source commit: 50e5191f7a0e8cf7b47565c808de9f6c181bb81a
Run: 33961499082
Install: success
Tests: failure
TypeScript: success
...
## failing tests
```text
not ok 104 - INCOME-DATE-01: salary duplicate guard uses the normalized 27/6 date and salary-cycle window
  ---
  duration_ms: 33.480757
  type: 'test'
  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:1:10993'
  failureType: 'testCodeFailure'
  error: 'addTransaction must normalize historical/short dates before income guard'
  code: 'ERR_ASSERTION'
  name: 'AssertionError'
  expected: true
  actual: false
  operator: '=='
  stack: |-
    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:299:10)
...
621-  ---
622-  duration_ms: 0.744289
623-  type: 'test'
624-  ...
625-# Subtest: INCOME-DATE-01: salary duplicate guard uses the normalized 27/6 date and salary-cycle window
626:not ok 104 - INCOME-DATE-01: salary duplicate guard uses the normalized 27/6 date and salary-cycle window
627-  ---
628-  duration_ms: 33.480757
629-  type: 'test'
630-  location: '/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:1:10993'
631-  failureType: 'testCodeFailure'
632:  error: 'addTransaction must normalize historical/short dates before income guard'
...
637-  operator: '=='
638-  stack: |-
639-    TestContext.<anonymous> (/home/runner/work/masroufi-ai/masroufi-ai/tests/financial.test.ts:299:10)
...
ok 36 - CONC-13: reviewed receipt/import lines are prepared directly and persisted by one bounded batch
  ---
  duration_ms: 7.883847
--- tests log tail ---
  ...
# Subtest: MARKET-23: Bank of Israel FX payload parser preserves representative source date
ok 195 - MARKET-23: Bank of Israel FX payload parser preserves representative source date
  ---
  duration_ms: 0.319952
  type: 'test'
  ...
# Subtest: MARKET-24: converted FX market results expose source/date metadata and reject Infinity
ok 196 - MARKET-24: converted FX market results expose source/date metadata and reject Infinity
  ---
  duration_ms: 0.86321
  type: 'test'
  ...
# Subtest: MARKET-25: saved and live market results spread FX metadata when conversion succeeds
ok 197 - MARKET-25: saved and live market results spread FX metadata when conversion succeeds
  ---
  duration_ms: 5.950996
  type: 'test'
  ...
# Subtest: OFF-01: FakeDb.set returns durability=pending on Firestore failure
ok 198 - OFF-01: FakeDb.set returns durability=pending on Firestore failure
  ---
  duration_ms: 7.579784
  type: 'test'
  ...
# Subtest: OFF-02: offline queue persists in IndexedDB (survives browser reload)
ok 199 - OFF-02: offline queue persists in IndexedDB (survives browser reload)
  ---
  duration_ms: 4.263943
  type: 'test'
  ...
# Subtest: OFF-03: queue keyed by userId (survives Cloud Run restart, client-side)
ok 200 - OFF-03: queue keyed by userId (survives Cloud Run restart, client-side)
  ---
  duration_ms: 2.05105
  type: 'test'
  ...
# Subtest: OFF-04: syncPendingOps attempts to sync on fetchData
ok 201 - OFF-04: syncPendingOps attempts to sync on fetchData
  ---
  duration_ms: 1.683605
  type: 'test'
  ...
# Subtest: OFF-05: retry does not duplicate after the operation completed
ok 202 - OFF-05: retry does not duplicate after the operation completed
  ---
  duration_ms: 0.464704
  type: 'test'
  ...
# Subtest: OFF-06: server committed but response lost — retry returns cached result
ok 203 - OFF-06: server committed but response lost — retry returns cached result
  ---
  duration_ms: 0.852344
  type: 'test'
  ...
# Subtest: OFF-06B: offline income parser cannot manufacture server business confirmations
ok 204 - OFF-06B: offline income parser cannot manufacture server business confirmations
  ---
  duration_ms: 3.617796
  type: 'test'
  ...
