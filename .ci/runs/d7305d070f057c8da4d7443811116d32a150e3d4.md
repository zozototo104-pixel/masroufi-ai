...
Source commit: d7305d070f057c8da4d7443811116d32a150e3d4
Run: 34821690944
Install: success
Tests: failure
TypeScript: failure
...
src/server/tools.ts(1479,200): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(1851,199): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2243,213): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2289,23): error TS2339: Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; } | { exists: boolean; data: () => any; partial: boolean; error: any; }'.
  Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; }'.
src/server/tools.ts(2311,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2319,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2345,39): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(2542,205): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2881,198): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3246,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3246,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3254,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3335,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3697,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(6402,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(7561,33): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(8376,44): error TS2554: Expected 1 arguments, but got 2.
```
