...
Source commit: ac721ccd5bd9e1795f9fdc3e1f17c095f3113339
Run: 34018032101
Install: success
Tests: success
TypeScript: failure
...
src/server/tools.ts(2668,51): error TS2339: Property 'reason' does not exist on type '{ ok: true; deleted: any[]; balances: BalanceSnapshot; balanceReadSource: string; } | { ok: false; reason: string; balances?: any; found?: number; requested?: number; }'.
  Property 'reason' does not exist on type '{ ok: true; deleted: any[]; balances: BalanceSnapshot; balanceReadSource: string; }'.
src/server/tools.ts(2668,97): error TS2339: Property 'found' does not exist on type '{ ok: true; deleted: any[]; balances: BalanceSnapshot; balanceReadSource: string; } | { ok: false; reason: string; balances?: any; found?: number; requested?: number; }'.
