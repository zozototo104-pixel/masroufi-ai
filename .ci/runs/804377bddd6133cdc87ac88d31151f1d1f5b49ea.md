...
Source commit: 804377bddd6133cdc87ac88d31151f1d1f5b49ea
Run: 34018744954
Install: success
Tests: success
TypeScript: failure
...
src/server/tools.ts(2760,51): error TS2339: Property 'reason' does not exist on type '{ ok: true; deleted: any[]; balances: BalanceSnapshot; balanceReadSource: string; } | { ok: false; reason: string; balances?: any; found?: number; requested?: number; }'.
  Property 'reason' does not exist on type '{ ok: true; deleted: any[]; balances: BalanceSnapshot; balanceReadSource: string; }'.
src/server/tools.ts(2760,97): error TS2339: Property 'found' does not exist on type '{ ok: true; deleted: any[]; balances: BalanceSnapshot; balanceReadSource: string; } | { ok: false; reason: string; balances?: any; found?: number; requested?: number; }'.
