...
Source commit: 9e5e5e652e47985cf3928cda48606d7c28a4573a
Run: 34774021727
Install: success
Tests: failure
TypeScript: failure
...
ok 32 - CONC-09: stale pending idempotency keys never auto-reexecute financial mutations
  ---
  duration_ms: 0.827879
--- tests log tail ---
  ...
# Subtest: MARKET-23: Bank of Israel FX payload parser preserves representative source date
ok 228 - MARKET-23: Bank of Israel FX payload parser preserves representative source date
  ---
  duration_ms: 0.308036
  type: 'test'
  ...
# Subtest: MARKET-24: converted FX market results expose source/date metadata and reject Infinity
ok 229 - MARKET-24: converted FX market results expose source/date metadata and reject Infinity
  ---
  duration_ms: 0.783996
  type: 'test'
  ...
# Subtest: MARKET-25: saved and live market results spread FX metadata when conversion succeeds
ok 230 - MARKET-25: saved and live market results spread FX metadata when conversion succeeds
  ---
  duration_ms: 6.060848
  type: 'test'
  ...
# Subtest: OFF-01: FakeDb.set returns durability=pending on Firestore failure
ok 231 - OFF-01: FakeDb.set returns durability=pending on Firestore failure
  ---
  duration_ms: 16.971535
  type: 'test'
  ...
# Subtest: OFF-02: offline queue persists in IndexedDB (survives browser reload)
ok 232 - OFF-02: offline queue persists in IndexedDB (survives browser reload)
  ---
  duration_ms: 3.049978
  type: 'test'
  ...
# Subtest: OFF-03: queue keyed by userId (survives Cloud Run restart, client-side)
ok 233 - OFF-03: queue keyed by userId (survives Cloud Run restart, client-side)
  ---
  duration_ms: 2.449202
  type: 'test'
  ...
# Subtest: OFF-04: syncPendingOps attempts to sync on fetchData
ok 234 - OFF-04: syncPendingOps attempts to sync on fetchData
  ---
  duration_ms: 2.628927
  type: 'test'
  ...
# Subtest: OFF-05: retry does not duplicate after the operation completed
ok 235 - OFF-05: retry does not duplicate after the operation completed
  ---
  duration_ms: 0.470743
  type: 'test'
  ...
# Subtest: OFF-06: server committed but response lost — retry returns cached result
ok 236 - OFF-06: server committed but response lost — retry returns cached result
  ---
  duration_ms: 0.744543
  type: 'test'
  ...
# Subtest: OFF-06B: offline income parser cannot manufacture server business confirmations
ok 237 - OFF-06B: offline income parser cannot manufacture server business confirmations
  ---
  duration_ms: 4.054916
  type: 'test'
  ...
# Subtest: OFF-07: Login A → logout → Login B cannot see/sync A queue
ok 238 - OFF-07: Login A → logout → Login B cannot see/sync A queue
  ---
  duration_ms: 2.246873
  type: 'test'
  ...
# Subtest: OFF-08: pending ops include operationId, userId, commandType, args, createdAt, retryCount
ok 239 - OFF-08: pending ops include operationId, userId, commandType, args, createdAt, retryCount
  ---
  duration_ms: 1.577802
  type: 'test'
  ...
# Subtest: OFF-09: pending ops carry syncStatus states (PENDING, SYNCING, COMMITTED, FAILED)
ok 240 - OFF-09: pending ops carry syncStatus states (PENDING, SYNCING, COMMITTED, FAILED)
  ---
  duration_ms: 1.419034
  type: 'test'
  ...
# Subtest: ATOMIC-DEBT-01: payDebt no longer has txRef.set fallback after atomic failure
ok 241 - ATOMIC-DEBT-01: payDebt no longer has txRef.set fallback after atomic failure
  ---
  duration_ms: 13.573021
  type: 'test'
  ...
# Subtest: ATOMIC-DEBT-02: payDebt returns retryable=true on contention/quota
ok 242 - ATOMIC-DEBT-02: payDebt returns retryable=true on contention/quota
  ---
  duration_ms: 4.209014
  type: 'test'
  ...
# Subtest: TRANSFER-CONC-01: transferMoney uses atomicTransferMoney
ok 243 - TRANSFER-CONC-01: transferMoney uses atomicTransferMoney
  ---
  duration_ms: 5.13162
  type: 'test'
  ...
# Subtest: TRANSFER-CONC-02: atomicTransferMoney exists in atomicOps
ok 244 - TRANSFER-CONC-02: atomicTransferMoney exists in atomicOps
  ---
  duration_ms: 1.676589
  type: 'test'
  ...
# Subtest: TRANSFER-CONC-03: transferMoney has NO direct write fallback
ok 245 - TRANSFER-CONC-03: transferMoney has NO direct write fallback
  ---
  duration_ms: 3.273533
  type: 'test'
  ...
# Subtest: OFFLINE-COMMAND-01: offlineQueue stores commandType + args (not final document)
ok 246 - OFFLINE-COMMAND-01: offlineQueue stores commandType + args (not final document)
  ---
  duration_ms: 1.392955
  type: 'test'
  ...
# Subtest: OFFLINE-COMMAND-02: offlineQueue sends through /api/command (NOT /api/sync)
ok 247 - OFFLINE-COMMAND-02: offlineQueue sends through /api/command (NOT /api/sync)
  ---
  duration_ms: 1.14391
  type: 'test'
  ...
# Subtest: OFFLINE-COMMAND-03: /api/command endpoint exists in server.ts
ok 248 - OFFLINE-COMMAND-03: /api/command endpoint exists in server.ts
  ---
  duration_ms: 4.061105
  type: 'test'
  ...
# Subtest: OFFLINE-COMMAND-04: dispatchFinancialCommand routes to tool handlers
ok 249 - OFFLINE-COMMAND-04: dispatchFinancialCommand routes to tool handlers
  ---
  duration_ms: 1.187752
  type: 'test'
  ...
# Subtest: OFFLINE-COMMAND-05: /api/sync is NOT a financial backdoor (syncOfflineData does doc.set for non-financial only)
ok 250 - OFFLINE-COMMAND-05: /api/sync is NOT a financial backdoor (syncOfflineData does doc.set for non-financial only)
  ---
  duration_ms: 1.351398
  type: 'test'
  ...
# Subtest: UNIFIED-PENDING-01: V6.2 uses new queue key (masrofi_pending_ops_v6_2)
ok 251 - UNIFIED-PENDING-01: V6.2 uses new queue key (masrofi_pending_ops_v6_2)
  ---
  duration_ms: 0.988079
  type: 'test'
  ...
# Subtest: UNIFIED-PENDING-02: migrateLegacyPendingOps function exists
ok 252 - UNIFIED-PENDING-02: migrateLegacyPendingOps function exists
  ---
  duration_ms: 0.873995
  type: 'test'
  ...
# Subtest: UNIFIED-PENDING-03: App.tsx calls migrateLegacyPendingOps on fetchData
ok 253 - UNIFIED-PENDING-03: App.tsx calls migrateLegacyPendingOps on fetchData
  ---
  duration_ms: 2.25352
  type: 'test'
  ...
# Subtest: UNIFIED-PENDING-04: logout clears ALL pending keys (v6_2 + legacy)
ok 254 - UNIFIED-PENDING-04: logout clears ALL pending keys (v6_2 + legacy)
  ---
  duration_ms: 2.713106
  type: 'test'
  ...
# Subtest: PARTIAL-STATE-01: addTransaction rejects on partial snapshot
ok 255 - PARTIAL-STATE-01: addTransaction rejects on partial snapshot
  ---
  duration_ms: 4.192147
  type: 'test'
  ...
# Subtest: PARTIAL-STATE-02: transferMoney rejects on partial balance
ok 256 - PARTIAL-STATE-02: transferMoney rejects on partial balance
  ---
  duration_ms: 3.960379
  type: 'test'
  ...
# Subtest: PARTIAL-STATE-03: payDebt rejects on partial snapshot
ok 257 - PARTIAL-STATE-03: payDebt rejects on partial snapshot
  ---
  duration_ms: 5.348837
  type: 'test'
  ...
# Subtest: FIRESTORE-READS-01: atomic ops use runTransaction (O(N) acknowledged, V7 will add financialState)
ok 258 - FIRESTORE-READS-01: atomic ops use runTransaction (O(N) acknowledged, V7 will add financialState)
  ---
  duration_ms: 6.860795
  type: 'test'
  ...
# Subtest: STATIC-SAFETY-01: no "catch + txRef.set" pattern in payDebt
ok 259 - STATIC-SAFETY-01: no "catch + txRef.set" pattern in payDebt
  ---
  duration_ms: 4.047191
  type: 'test'
  ...
# Subtest: STATIC-SAFETY-02: no "catch + txRef.set" pattern in transferMoney
ok 260 - STATIC-SAFETY-02: no "catch + txRef.set" pattern in transferMoney
  ---
  duration_ms: 3.016944
  type: 'test'
  ...
# Subtest: SYNC-AUTH-01: dispatchFinancialCommand overwrites client userId
ok 261 - SYNC-AUTH-01: dispatchFinancialCommand overwrites client userId
  ---
  duration_ms: 1.25086
  type: 'test'
  ...
# Subtest: IDEM-01: dispatchFinancialCommand passes operationId through args
ok 262 - IDEM-01: dispatchFinancialCommand passes operationId through args
  ---
  duration_ms: 0.899122
  type: 'test'
  ...
1..262
# tests 262
...
src/server/tools.ts(1229,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 7 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(1229,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 7 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(1237,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(1318,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(1668,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(4283,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(5878,44): error TS2554: Expected 1 arguments, but got 2.
```
...
[2mdist/[22m[2massets/[22m[35mindex-uSZHiVAy.css           [39m[1m[2m 68.52 kB[22m[1m[22m[2m │ gzip:  11.44 kB[22m
...
[2mdist/[22m[2massets/[22m[36mindex-bcVNw4ot.js            [39m[1m[2m254.22 kB[22m[1m[22m[2m │ gzip:  62.70 kB[22m[2m │ map:   643.36 kB[22m
