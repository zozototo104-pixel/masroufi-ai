...
Source commit: 1e76bf9168623a32ba5922ea926aab6114ba9142
Run: 34773615301
Install: success
Tests: failure
TypeScript: failure
...
src/server/tools.ts(1058,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 7 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(1058,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 7 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(1066,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(1147,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(1497,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(4112,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(5705,44): error TS2554: Expected 1 arguments, but got 2.
```
