...
Source commit: 35c73ba0a94a5093719a03444ea149b0a7966f06
Run: 34788026478
Install: success
Tests: failure
...
src/server/tools.ts(1467,200): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(1813,199): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2188,213): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2234,23): error TS2339: Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; } | { exists: boolean; data: () => any; partial: boolean; error: any; }'.
  Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; }'.
src/server/tools.ts(2256,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2264,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2290,39): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(2472,205): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2759,198): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3125,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3125,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3133,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3214,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3576,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(6281,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(8208,44): error TS2554: Expected 1 arguments, but got 2.
```
