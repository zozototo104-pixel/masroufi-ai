...
Source commit: 00cf04dd4350f5e1bc1234060a3ea3eac26f7639
Run: 34807398262
Install: success
Tests: failure
TypeScript: failure
...
src/server/tools.ts(1816,199): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2203,213): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2249,23): error TS2339: Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; } | { exists: boolean; data: () => any; partial: boolean; error: any; }'.
  Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; }'.
src/server/tools.ts(2271,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2279,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2305,39): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(2487,205): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2784,198): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3150,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3150,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3158,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3239,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3601,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(6306,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(8254,44): error TS2554: Expected 1 arguments, but got 2.
```
