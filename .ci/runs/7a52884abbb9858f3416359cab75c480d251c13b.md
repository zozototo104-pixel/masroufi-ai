...
Source commit: 7a52884abbb9858f3416359cab75c480d251c13b
Run: 34785584357
Install: success
Tests: failure
TypeScript: failure
...
src/server/tools.ts(1398,200): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(1744,199): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2119,213): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2165,23): error TS2339: Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; } | { exists: boolean; data: () => any; partial: boolean; error: any; }'.
  Property 'id' does not exist on type '{ exists: boolean; data: () => any; partial: boolean; error?: undefined; }'.
src/server/tools.ts(2187,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2195,8): error TS2554: Expected 2 arguments, but got 3.
src/server/tools.ts(2221,39): error TS2339: Property 'id' does not exist on type 'SalaryCyclePeriod'.
src/server/tools.ts(2401,205): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2688,198): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3047,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3047,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 11 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(3055,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3136,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(3498,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(6203,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(8125,44): error TS2554: Expected 1 arguments, but got 2.
```
