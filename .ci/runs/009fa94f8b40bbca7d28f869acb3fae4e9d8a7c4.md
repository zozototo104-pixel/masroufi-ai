...
Source commit: 009fa94f8b40bbca7d28f869acb3fae4e9d8a7c4
Run: 34779223148
Install: success
Tests: failure
TypeScript: failure
...
src/server/tools.ts(2399,79): error TS2339: Property 'decision' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 7 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'decision' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(2399,108): error TS2339: Property 'safeSpending' does not exist on type '{ success: boolean; decision: string; message: string; safeSpending: { currency: any; horizon: { period: string; label: string; startIso: string; endIso: string; daysRemaining: number; salaryCycle: SalaryCyclePeriod; }; ... 7 more ...; cashFlowGap: number; }; ... 7 more ...; readEfficiency: any; } | { ...; }'.
  Property 'safeSpending' does not exist on type '{ success: boolean; message: any; }'.
src/server/tools.ts(2407,65): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2488,24): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(2850,5): error TS2322: Type '"" | "cash" | "palPay" | "debt"' is not assignable to type '"cash" | "palPay" | "debt"'.
  Type '""' is not assignable to type '"cash" | "palPay" | "debt"'.
src/server/tools.ts(5542,8): error TS2554: Expected 1 arguments, but got 2.
src/server/tools.ts(7464,44): error TS2554: Expected 1 arguments, but got 2.
```
