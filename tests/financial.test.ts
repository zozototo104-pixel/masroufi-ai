...
test('DELETE-DATE-01: smart delete can find exact-date cash tracking rows outside recent createdAt window', async () => {
  ...
  assert.ok(!serverSrc.includes('completing pending clarification from Live transcript') && !serverSrc.includes('livePendingClarificationRunning'), 'pending financial clarification must not execute tools directly from the Live audio transcript path');
